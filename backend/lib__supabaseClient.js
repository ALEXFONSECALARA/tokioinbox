...
// do prompt mestre / backend/db.supabase.js pra como o isolamento por
...
// null e backend/db.js cai automaticamente pro backend em JSON (fallback
...
if (!supabaseEnabled) {
  console.log('ℹ️  SUPABASE_URL/SUPABASE_SERVICE_ROLE_KEY não configurados — usando o backend em arquivos JSON (backend/).');
}
