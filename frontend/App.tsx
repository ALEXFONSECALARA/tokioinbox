...
} from './data__initialData';
import { fetchMenu, createOrder, fetchOrder, fetchOperationalStatus, fetchCustomerProfile, subscribeToOrderEvents } from './utils__api';
import { isPushSubscribed, subscribeToPush, unsubscribeFromPush } from './utils__push';
import { formatCurrency, playSoundEffect, COUPONS } from './utils__helpers';
import { SplashScreen } from './components__restaurant__SplashScreen';
import { Header } from './components__restaurant__Header';
import { ConnectionBanner } from './components__system__ConnectionBanner';
import { CategoryNav } from './components__order__CategoryNav';
import { ProductCard } from './components__order__ProductCard';
import { ProductModal } from './components__order__ProductModal';
import { CartDrawer } from './components__order__CartDrawer';
import { CheckoutModal } from './components__order__CheckoutModal';
import { OrderStatusModal } from './components__order__OrderStatusModal';
import { DeliveryAddressModal } from './components__customer__DeliveryAddressModal';
import { FavoritesModal } from './components__customer__FavoritesModal';
import { CustomerAccountModal } from './components__customer__CustomerAccountModal';
import { AssistantChat } from './components__restaurant__AssistantChat';
import { InstallPrompt } from './components__customer__InstallPrompt';
import { 
  ShoppingBag, 
  Bike,
  ChefHat, 
