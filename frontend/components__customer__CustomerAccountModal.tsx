      ...
      <div className="bg-white w-full sm:max-w-md sm:rounded-3xl rounded-t-3xl max-h-[92dvh] overflow-y-auto p-4 sm:p-5 space-y-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
        ...
        {!token || !customer ? (
          <form onSubmit={handleAuthSubmit} className="space-y-3">
            <div className="rounded-xl bg-stone-50 border border-stone-200 p-3 text-xs text-stone-600">Entre com seu telefone e sua senha para acompanhar pedidos, endereços e histórico.</div>
