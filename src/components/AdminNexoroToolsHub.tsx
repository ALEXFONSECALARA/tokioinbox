...
export const NEXORO_TOOLS: NexoroToolDefinition[] = [
  ...
  },
  {
    ...
    icon: Bot,
    summary: 'Concierge gastronômico e motor de conversão com Gemini AI.',
    items: [
      'Chatbot inteligente (cardápio, promoções, pedidos)',
      'Recomendações e combos personalizados',
