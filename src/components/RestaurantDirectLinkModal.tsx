...
export const RestaurantDirectLinkModal: React.FC<RestaurantDirectLinkModalProps> = ({
  ...
  const officialUrl = getRestaurantDirectUrl(restaurant, 'official');
  const currentPreviewUrl = getRestaurantDirectUrl(restaurant, 'current');
  const activeUrl = selectedDomainMode === 'official' ? officialUrl : currentPreviewUrl;
  const qrCodeUrl = getQrCodeImageUrl(activeUrl, 320);
            ...
            <div className="space-y-2 text-center sm:text-left flex-1">
              ...
              <div className="flex items-center justify-center sm:justify-start gap-2 pt-1">
                <a
                  ...
                  className="px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-semibold text-[11px] flex items-center gap-1.5 transition-colors"
                >
