...
const dbJson=await readFile(new URL('../../../server/lib/adapters/db.json.js',import.meta.url),'utf8');
const migration=await readFile(new URL('../../../supabase/migrations/0020_v14_v18.sql',import.meta.url),'utf8');
const bridge=await readFile(new URL('../../../server/print-bridge/bridge.mjs',import.meta.url),'utf8');
