...
# Rodada 5 — Cancelar/excluir histórico no Kanban, Kanban unificado (REMOVIDO na V27.3) invisível, RLS de clientes
...
## 20. "Kanban unificado (REMOVIDO na V27.3)" (todos os restaurantes numa tela só) já existia, mas ninguém achava
Investiguei o pedido de "Kanban unificado (REMOVIDO na V27.3) pra todos os restaurantes sem precisar
...
**Corrigido:** adicionado um botão "🍽️ Kanban unificado (REMOVIDO na V27.3) (todos)" bem visível na
